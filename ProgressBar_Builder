(function () {
    ...
    <form id="form">
        <table>
            ...
            <tr>
                <td>
                    <p>Bar Color</p>
                    <input id="builder_barColor" type="color" placeholder="Select Bar Color">
                </td>
            </tr>
            <tr>
                <td>
    ...
    class StraightProgressBarBuilderPanel extends HTMLElement {
        ...
        set barColor(value) {
            this._shadowRoot.getElementById("builder_barColor").value = value;
        }
        get barColor() {
    ...
    customElements.define("com-gr-progressbar-builder", StraightProgressBarBuilderPanel);
})();
